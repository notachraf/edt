...
(200, 6, 'L1 INFO', 'IN100, IN101, IN102', '2021-02-01');



INSERT INTO Professeur (prof_nom, prof_cours) VALUES
('Lemoine', 'IN101, IN100, IN100'),
('Delaunay', 'IN101, IN100'),
('Millet', 'IN100, IN101, IN102'),
('Collet', 'IN100, IN101, IN102'),
('Bailly', 'IN100, IN101'),
('Fabre', 'IN100, IN101, IN102'),
('Rousseau', 'IN100, IN101'),
('Faure', 'IN100, IN102'),
('Andre', 'IN100');